let p20 = {title:"Physics 20", article:"Home", links:[
    ...
    {title:"Brightspace", url:"https://eips.brightspace.com/d2l/home/26288", icon:"bs"},
	...
	{title:"Topic 1: Energy", article:"Loading", id:"energy", links:[
        {title:"Assignment Booklet", gdrv:"."},
        {title:"Bar Chart", ajax:"energy/barchart.htm#_BarChart", icon:"html5"},
    ], nodes:[
		{title:"Mechanical Energy", ajaxx:"", nodes:[]},
	]},
	{title:"Topic 2: Kinematics (1D)", id:"kin1d", article:"Choose", nodes:[]},
	// {title:"Topic 3: Dynamics", id:"dyn", article:"Choose", nodes:[]},
	{title:"Topic 4: Circular & Orbital Motion", id:"circ", links:[
        {title:"Heliocentric Model", ajax:"circ/helio.htm#Helio", icon:"html5"},
    ], nodes:[]},
	// {title:"Topic 5: Universal Gravitation", id:"grav", article:"Choose", nodes:[]},
	// {title:"Topic 6: Oscillations", id:"osc", article:"Choose", nodes:[]},
	// {title:"Topic 7: Mechanical Waves", id:"wave", article:"Choose", nodes:[]},
	// {title:"Topic 8: 2D Vectors", id:"vec2d", article:"Choose", nodes:[]},
]}
