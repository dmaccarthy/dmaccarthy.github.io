let kin1d = [
    ...
    {title:"Position & Displacement", icon:1, vid:"V8hJhTE3bUk", menu:[
        ...
        {title:"Assignment Handout", icon:"gdrv", open:"https://drive.google.com/file/d/13YDvlb2IifPhmuuTyGMwO65T82H77bzL"},
    ...
    {title:"Lab: Motion of a Bouncing Ball", icon:"ball", menu:[
        {title:"Handout", icon:"gdrv", open:"https://drive.google.com/file/d/10Huo142Lt2-qn3suDdfvbK3wp6Cg2TeA"},
    ...
    {title:"Uniform Accelerated Motion", icon:1, menu:[
        ...
        {title:"Assignment Handout", icon:"gdrv", js:"unavail()", opxn:"https://drive.google.com/file/d/1FkSyKa-Sd_jvq5MhwjypL0p1MtL__jMv/view?usp=sharing"},
...
let energy = [
    ...
    {title:"Lab: Energy Transformation on a Ramp", icon:1, menu:[
        {title:"Handout (Live Experiment)", icon:"gdrv", open:"https://drive.google.com/file/d/1tSjy8SVnbKYEQSiBKyGj6i2DYtCpfvBH"},
        {title:"Handout (Simulation)", icon:"gdrv", open:"https://drive.google.com/file/d/1vUVexzbmqghH1hGGlGV8eWGMJC0C0sOQ"},
    ...
    {title:"Work-Energy Theorem", icon:1, menu:[
        ...
        {title:"Assignment Handout", icon:"gdrv", open:"https://drive.google.com/file/d/1T6TmgI0K0F-rlx7xXMj-gNYA9twU-dxF"},
    ...
    {title:"Power & Efficiency", icon:1, menu:[
        ...
        {title:"Assignment Handout", icon:"gdrv", open:"https://drive.google.com/file/d/1ftuiOA79zM7EiV6Bq6OWSv9OYoQ2Od0h"},
...
let expDes = [
    ...
    {title:"Transforming Non-Linear Data", menu:[
        // {title:"Lesson Notes", openx:"skill/nonLin.html"},
