let mom = [
    ...
    {title:"Work-Energy Review", unavail:0, icon:1, menu:[
        {title:"Lesson Notes", open:"mom/we.html"},
        {title:"Practice Solutions", gdoc:""},
    ]},
    {title:"Momentum", icon:1, unavail:1, menu:[
        {title:"Lesson Notes", open:"mom/mom.html"},
        {title:"Practice Solutions", gdoc:""},
    ]},
    {title:"Impulse", icon:1, unavail:1, menu:[
        {title:"Lesson Notes", open:"mom/impulse.html"},
        {title:"Practice Solutions", gdoc:""},
    ]},
    {title:"Momentum Conservation", icon:1, unavail:1, menu:[
        {title:"Lesson Notes", open:"mom/pCons.html"},
        {title:"Practice Solutions", gdoc:""},
        {title:"Video Analysis", icon:"html5", open:"../tools/vid_analysis/"},
    ]},
    {title:"Elastic & Inelastic Collisions", icon:1, unavail:1, menu:[
        {title:"Lesson Notes", open:"mom/collide.html"},
        {title:"Practice Solutions", gdoc:""},
    ]},
    {title:"2D Vectors Review", icon:1, unavail:1, menu:[
        {title:"Lesson Notes", open:"mom/vec2d.html"},
        {title:"Practice Solutions", gdoc:""},
    ]},
    {title:"2D Collisions", icon:1, unavail:1, menu:[
