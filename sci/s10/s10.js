...
let chem = {title:"Unit A: Chemistry", id:"chem", icon:"flask", menu:[
    ...
    {title:"Part 1: Matter", id:"c1", icon:"flask", menu:[
        {title:"Lab Safety / WHMIS", icon:1, open:"chem/whmis.html"},
        {title:"Experiment Design [Lab]", icon:1, open:"chem/expDes.html"},
        {title:"Classifying Matter", icon:1, open:"chem/matter.html"},
        {title:"Atomic Theory", icon:1, open:"chem/atom.html"},
        {title:"Isotopes &amp; Ions", icon:1, open:"chem/isotope.html"},
        {title:"Bohr Model (Energy Levels)", icon:1, open:"chem/bohr.html"},
        {title:"Periodic Table &amp; Dot Diagrams", icon:1, open:"chem/dot.html"},
    ]},
